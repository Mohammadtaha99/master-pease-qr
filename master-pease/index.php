...
// Retrieve the QR code message from the POST request
$data = json_decode(file_get_contents('php://input'), true);
$qrCodeMessage = $data['qrCodeMessage'];

// Store the QR code message in the session
$_SESSION['qrCodeMessage'] = $qrCodeMessage;

// Return a response (optional)
echo 'QR code message received and stored in the session.';
?>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            <a href="index.html" class="navbar-brand ml-lg-3">
                ...
                <h1 class="m-0 display-5 text-uppercase text-primary"><img src="img/orange-logo.png" alt="" style="width:150px;height: 50px;"> Attendance</h1>
            </a>
            ...
            <div class="mx-auto" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                    <div class="row">
                        ...
                        <div id="result" style="width: 500px;height: 500px;">Result Here</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function onScanSuccess(qrCodeMessage) {
    // Send the QR code message to the PHP file
    fetch('process_qr_code.php', {
        method: 'POST',
        body: JSON.stringify({ qrCodeMessage: qrCodeMessage })
    })
    .then(response => {
